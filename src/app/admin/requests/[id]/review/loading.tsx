/** ponytail: shares FormCardSkeleton with animals/create — extract to shared if a fourth consumer appears */
...
export default function ReviewRequestLoading() {
  return (
    <div className="p-10 max-w-7xl mx-auto animate-pulse">
      {/* Header: badge pill + title + subtitle */}
      <header className="mb-10">
        <div className="h-5 w-52 bg-stone-200 rounded-full" />
        <div className="h-8 w-80 bg-stone-200 rounded mt-2" />
        <div className="h-4 w-[28rem] bg-stone-100 rounded mt-1" />
      </header>

      {/* Same AnimalForm skeleton as create/edit */}
